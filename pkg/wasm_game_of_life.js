...
export class Universe {
     ...
     * @param {number} col
     */
    insert_glider_at(row, col) {
        wasm.universe_insert_glider_at(this.__wbg_ptr, row, col);
    }
    /**
     * @param {number} row
     * @param {number} col
     */
    insert_pulsar_at(row, col) {
        wasm.universe_insert_pulsar_at(this.__wbg_ptr, row, col);
    }
    tick() {
